...
namespace GymMembers.Model
{
    ...
    public class Member : ObservableObject
    {
        ...
        /// <summary>
        /// Text Limit used for error handling.
        /// </summary>
        private int TEXT_LIMIT = 30;
        ...
        /// <summary>
        /// Information that is going to be displayed in the listbox of the mainwindow.
        /// </summary>
        /// <returns>first name, last name, and e-mail is returned</returns>
